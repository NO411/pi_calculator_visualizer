...
def main():
	...
	while not window_should_close():
		...
		draw_text_ex(font, "points = " + str(len(points)),
					 Vector2(10, 50), 30, 0, BLACK)

		draw_line(0, int(coordinate_origin.y), get_screen_width(),
				  int(coordinate_origin.y), BLACK)
		draw_line(int(coordinate_origin.x), 100, int(
